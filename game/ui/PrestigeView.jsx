            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="bg-slate-800 rounded-lg border border-slate-700 p-3">
                    ...
                    <div className="bg-slate-950 p-3 rounded-lg border border-slate-800">
                        ...
                        >
                            {hasBeatenLastBoss ? (<><svg className="w-4 h-4 inline mr-1" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>Ascend Now</>) : 'Locked'}
                        </button>
                    </div>
                </div>
        ...
        <div className="flex flex-col h-full gap-4">
            ...
            <div className="flex flex-col gap-4 p-5 bg-slate-800 rounded-xl border-2 border-slate-700 shadow-xl">
                ...
                <div className="bg-slate-950 p-5 rounded-lg border-2 border-slate-800 flex justify-between items-center">
                    ...
                    >
                        {hasBeatenLastBoss ? (<><svg className="w-5 h-5 inline mr-1" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>Ascend</>) : 'Locked'}
                    </button>
                </div>
            </div>
